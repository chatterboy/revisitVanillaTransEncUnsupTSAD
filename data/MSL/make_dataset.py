...
for chan_id in set(test_labels_info.loc[test_labels_info["spacecraft"] == "MSL", "chan_id"].tolist()):
...
np.save("MSL_train.npy", train)
np.save("MSL_test.npy", test)
np.save("MSL_test_labels.npy", test_labels)